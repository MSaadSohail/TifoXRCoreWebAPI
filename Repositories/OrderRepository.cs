...
{
    /// <summary>Data-access only. No payment gateway calls here.</summary>
    public sealed partial class OrderRepository : IOrderRepository
    {
        private readonly IDbProvider _db;
        public OrderRepository(IDbProvider db) => _db = db;
    }
}
...
//        {
//            const int PendingOrderStatusId = 2; // FIX ME: Fetch from DB
