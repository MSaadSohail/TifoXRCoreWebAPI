...
namespace GMS.TifoXRCoreWebAPI.Repositories
{
    ...
    public partial interface IOrderRepository
    {
        ...
        //    string? ProviderIntentId, int GatewayId)?> GetIntentContextAsync(string intentId);
        ...
        //Task MarkPaidIfCoveredAsync(string orderId, long amountJustCapturedMinor, 
        //    int paidStatusId);
        //Task GrantEntitlementsAsync(string orderId);
        //Task InsertInvoiceFromOrderAsync(int spaceId, string orderId, string chargeId, 
        //    int gatewayId);
    }
}
