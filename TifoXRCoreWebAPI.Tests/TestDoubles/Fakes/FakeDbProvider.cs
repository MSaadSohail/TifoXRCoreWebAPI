...
namespace GMS.TifoXRCoreWebAPI.Tests.TestDoubles.Fakes
{
    internal sealed class FakeDbProvider : IDbProvider
    {
        ...
        public Exception NonQueryException { get; set; } =
            new InvalidOperationException("Configured failure in ExecuteNonQuery");
        ...
        public void EnqueueReader(Func<DbDataReader> factory)
        {
            ...
            _readerResults.Enqueue(factory);
        }
        ...
        public DbParameter CreateParameter(string name, object? value)
            => new FakeParameter { ParameterName = name ?? string.Empty, Value = value };
        ...
        private sealed class FakeConnection : DbConnection
        {
            ...
            protected override ValueTask<DbTransaction> BeginDbTransactionAsync(
                ...
                => new(new FakeTransaction(_owner, this, isolationLevel));
        ...
        private sealed class FakeCommand : DbCommand
        {
            ...
            public override Task<int> ExecuteNonQueryAsync(CancellationToken cancellationToken)
            {
                ...
                return Task.FromResult(_owner.NextNonQuery());
            }
            ...
            public override Task<object?> ExecuteScalarAsync(CancellationToken cancellationToken)
            {
                ...
                return Task.FromResult(_owner.ScalarResults.Dequeue());
            }

            private void RecordSql() => _owner.ExecutedSql.Add(Normalize(CommandText));
