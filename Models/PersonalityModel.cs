...
namespace GMS.TifoXRCoreWebAPI.Models
{
    public class PersonalityData
    {
        ...
        public LocalizedPair LocalizedCountry { get; set; }
        public LocalizedPair LocalizedBio { get; set; }
    ...
    public class PersonalityCreateDto
    {
        ...
        public LocalizedPair LocalizedCountry { get; set; } = new();
        public LocalizedPair LocalizedBio { get; set; } = new();
